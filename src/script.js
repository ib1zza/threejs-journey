...
const spotLight = new THREE.SpotLight(0xffff00, 0.75, 10, Math.PI * 0.3, 0.25);
spotLight.position.set(-1, 2, 2);
spotLight.castShadow = true;
spotLight.shadow.mapSize.set(1024, 1024);
spotLight.shadow.camera.far = 5;
gui.add(spotLight, "intensity").min(0).max(1).step(0.001).name("spot");
...
const sphereShadow = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), new THREE.MeshBasicMaterial({ alphaMap: simpleShadow, side: THREE.DoubleSide, transparent: true, color: 0x000000 }));
